...
import com.bayshore.flutter_callkit.widgets.RippleRelativeLayout
...
class CallkitActivity : Activity() {

    companion object {

        private const val ACTION_ENDED_CALL_INCOMING =
                "com.bayshore.flutter_callkit.ACTION_ENDED_CALL_INCOMING"
    ...
    inner class EndedCallkitBroadcastReceiver : BroadcastReceiver() {
    ...
    private var endedCallkitBroadcastReceiver = EndedCallkitBroadcastReceiver()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requestedOrientation = if (!Utils.isTablet(this@CallkitActivity)) {
        ...
        setContentView(R.layout.activity_callkit)
        initView()
        incomingData(intent)
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            registerReceiver(
                endedCallkitBroadcastReceiver,
    ...
    private fun incomingData(intent: Intent) {
        ...
        if(appLogoUrl!=null) {
            ...
            getPicassoInstance(this@CallkitActivity, headers)
                .load(appLogoUrl)
    ...
    private fun initView() {
        ...
        params.setMargins(0, 0, 0, Utils.getNavigationBarHeight(this@CallkitActivity))
    ...
    private fun animateAcceptCall() {
        val shakeAnimation =
                AnimationUtils.loadAnimation(this@CallkitActivity, R.anim.shake_anim)
    ...
    private fun onDeclineClick() {
        val data = intent.extras?.getBundle(CallkitConstants.EXTRA_CALLKIT_INCOMING_DATA)
        val intent = CallkitBroadcastReceiver.getIntentDecline(this@CallkitActivity, data)
    ...
    override fun onDestroy() {
        unregisterReceiver(endedCallkitBroadcastReceiver)
        super.onDestroy()
    }
